...
export function SearchingState({
  ...
  return (
    <section aria-labelledby="searching-heading" className="text-center">
      <h1 id="searching-heading" className="text-xl font-bold text-[var(--color-text)]">
...
export function MatchFailedState({
  ...
  return (
    <section aria-labelledby="failed-heading">
      <h1 id="failed-heading" className="text-xl font-bold text-[var(--color-text)]">
      ...
      <div className="flex flex-wrap gap-2">
        {canEscalate ? (
          ...
          <button
            type="button"
            onClick={onEscalate}
            className="min-h-[var(--size-touch)] rounded-[var(--radius-action)] border border-[var(--color-danger)] px-4 text-sm font-semibold text-[var(--color-text)]"
          >
            Escalate
          </button>
        ) : null}
  ...
  if (role === 'requester') {
    return (
      <section aria-labelledby="feedback-heading">
        <h2 id="feedback-heading" className="text-lg font-bold text-[var(--color-text)]">
        ...
        <div className="mt-4 flex flex-col gap-2">
          {(
            ...
            <button
              ...
              className="min-h-[var(--size-touch)] rounded-[var(--radius-action)] border border-[var(--color-border)] px-5 text-left font-semibold text-[var(--color-text)]"
            >
              {label}
            </button>
          ))}
...
export function ThankYouState({ role, onHome }: { role: 'requester' | 'listener'; onHome: () => void }) {
  return (
    <section aria-labelledby="thanks-heading" className="text-center">
      <h2 id="thanks-heading" className="text-xl font-bold text-[var(--color-text)]">
