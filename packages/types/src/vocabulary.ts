 ...
 * moved here in E16-T04. PRD §23.1, DESIGN-REF §5.
 *
 * Shared rather than duplicated per app. Web and mobile must announce the same
 * mood by the same name: two copies of this file would drift on the first edit,
 * and the drift would be invisible until somebody compared a phone and a
